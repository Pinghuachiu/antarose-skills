...
if not CLIENT_ID or not CLIENT_SECRET:
    ...
    print("  python3 scripts/get-token-final.py")
    sys.exit(1)
...
auth_url = f"https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPES}&state={params['state']}"
...
print("4. 瀏覽器會重新導向（可能顯示錯誤頁面，這是正常的）")
print("5. 從瀏覽器網址列複製完整 URL")
print("6. 粘貼到下面\n")
