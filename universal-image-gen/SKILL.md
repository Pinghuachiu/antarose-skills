...
- **Base URL**: `http://192.168.1.159:8045`
- **文生圖端點**: `/v1/images/generations` (OpenAI 格式)
- **圖生圖端點**: `/v1/images/edits` (OpenAI 格式)
...
- 優先使用 Antigravity API（支援文生圖和圖生圖）
- 失敗時自動切換到 NanoBanana
- NanoBanana 支援文生圖和圖生圖
- 無需手動切換，完全自動化

**✅ 現已支援**：Antigravity API 已更新支援圖生圖功能（使用 `/v1/images/edits` 端點）！
