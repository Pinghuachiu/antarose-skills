...
# 可選模型
MODEL_PRO = "nanobanana-3-pro-image"  # NanoBanana Pro (最強）
MODEL_FLASH = "nanobanana-2.5-flash-image"  # Flash (快速）
    ...
    try:
        ...
        if 'candidates' in result and len(result['candidates']) > 0:
            ...
            if len(parts) > 0 and 'inlineData' in parts[0]:
                image_data = parts[0]['inlineData']['data']
                image_type = parts[0]['inlineData']['mimeType']
